...
const SettingsPage = () => {
    ...
    return (
        ...
        <div
            ...
            <p className="center setting-time-p"><strong>Daily Calendar will auto-scroll to time below on page startup</strong></p>
            ...
            <br />
            <h3>Click image below to your change profile picture</h3>
            <br />
            <div>
                <img
